    ...
    <div class="hero">
        <div class="hero-grid">
            <div>
                ...
                <p>Choose symptoms, review the most likely condition, and explore a more cinematic healthcare interface built to feel like a polished product showcase.</p>
...
with tab_predict:
    ...
    with left:
        ...
        if predict_clicked:
            ...
            with score_left:
                ...
                st.markdown(
                    ...
                    <div class="score-card">
                        ...
                        <div class="section-note">This score reflects how strongly the selected symptom pattern matches the leading disease class in the demo model.</div>
                    </div>
                    """,
                    unsafe_allow_html=True,
                )
            ...
            st.caption("Use this output as a demo prediction summary, not as a medical diagnosis.")
        else:
            st.markdown(
                """
                <div class="spotlight">
    ...
    with right:
        ...
        st.markdown(
            ...
            <div class="info-card">
                ...
                <p class="section-note">For a more convincing demo, combine core symptoms with one or two support symptoms rather than selecting every symptom at once. This usually creates a cleaner disease ranking and a stronger main result card.</p>
            </div>
            """,
            unsafe_allow_html=True,
        )
...
with tab_insights:
    st.markdown(
        ...
        <div class="page-hero">
            <div class="insight-banner">
                ...
                <div style="font-size:2rem; font-weight:800; margin-top:6px;">How this prediction demo is structured</div>
            ...
            <div class="page-panel">
                ...
                <div style="font-size:1.2rem; color:#12355b; font-weight:800; margin-top:6px;">{metrics['accuracy'] * 100:.2f}% demo accuracy</div>
    ...
    st.markdown(
        ...
        <div class="info-card">
            ...
            <p class="section-note">The score shown in the prediction page is a model confidence estimate within this demo environment, not a clinical certainty score. The app is designed for project demonstration, interface presentation, and classification workflow explanation rather than medical deployment.</p>
        </div>
        """,
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        ...
        <div class="page-hero">
            ...
            <div class="page-panel">
                ...
                <div style="font-size:1.2rem; color:#12355b; font-weight:800; margin-top:6px;">Built for demos, viva, and portfolios</div>
    ...
    st.markdown(
        ...
        <div class="feature-grid">
            <div class="feature-box">
                <h4>Project Goal</h4>
                <p>Create a disease prediction application that looks strong enough for demos, presentations, and portfolio reviews.</p>
            </div>
            <div class="feature-box">
    ...
    with about_left:
        st.markdown(
            ...
            <div class="info-card">
                ...
                <p class="section-note">This project is useful because it demonstrates both the machine learning pipeline and the front-end presentation layer. It can be shown in college reviews, final-year project demos, internship portfolios, or software showcases where visual polish matters alongside the prediction logic.</p>
            </div>
            """,
            unsafe_allow_html=True,
        )
        ...
        <div class="info-card">
            ...
            <div class="timeline">
                ...
                <div class="timeline-item">
                    ...
                    <p>Add downloadable patient summary cards or PDF-style reports for project demonstrations.</p>
                </div>
                <div class="timeline-item">
